...
function InteractionProvider(props) {
  ...
  return (0, import_jsx_runtime8.jsx)(InteractionContext.Provider, {
    value,
    children
  });
}
...
function useSeries() {
  const {
    isInitialized,
    data
  } = React20.useContext(SeriesContext);
  if (!isInitialized) {
...
function usePieSeries() {
  ...
  return React20.useMemo(() => series.pie, [series.pie]);
}
...
function CartesianProvider(props) {
  ...
  return (0, import_jsx_runtime9.jsx)(CartesianContext.Provider, {
    value,
    children
  });
}
...
var useAxisEvents = (disableAxisListener) => {
  ...
  const mousePosition = React25.useRef({
    isInChart: false,
    x: -1,
    y: -1
  });
...
var ZAxisContext = React28.createContext({
  zAxis: {},
  zAxisIds: []
});
if (true) {
...
function ZAxisContextProvider(props) {
  ...
  const zAxis = React28.useMemo(() => inZAxis == null ? void 0 : inZAxis.map((axisConfig) => {
  ...
  return (0, import_jsx_runtime12.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold2, index2) => {
      ...
      return (0, import_jsx_runtime12.jsxs)(React30.Fragment, {
        children: [(0, import_jsx_runtime12.jsx)("stop", {
          offset: offset2,
          stopColor: colorMap.colors[index2],
          stopOpacity: 1
        }), (0, import_jsx_runtime12.jsx)("stop", {
          offset: offset2,
...
function ChartsContinuousGradient(props) {
  ...
  return (0, import_jsx_runtime13.jsx)("linearGradient", {
    ...
    children: Array.from({
      ...
      return (0, import_jsx_runtime13.jsx)("stop", {
        offset: offset2,
        stopColor: color2,
        stopOpacity: 1
      }, keyPrefix + index2);
...
function useChartGradient() {
  ...
  return React32.useCallback((axisId, direction) => `${chartId}-gradient-${direction}-${axisId}`, [chartId]);
}
function ChartsAxesGradients() {
  ...
  return (0, import_jsx_runtime14.jsxs)("defs", {
    children: [yAxisIds.filter((axisId) => yAxis[axisId].colorMap !== void 0).map((axisId) => {
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "piecewise") {
        return (0, import_jsx_runtime14.jsx)(ChartsPiecewiseGradient, {
          isReversed: !reverse2,
          scale,
          colorMap,
          size: svgHeight,
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "continuous") {
        return (0, import_jsx_runtime14.jsx)(ChartsContinuousGradient, {
          isReversed: !reverse2,
          scale,
          colorScale,
          colorMap,
...
var HighlightedContext = React33.createContext({
  isInitialized: false,
  data: {
...
function HighlightedProvider({
  ...
  const series = useSeries();
  const seriesById = React34.useMemo(() => {
  ...
  const providerValue = React34.useMemo(() => {
    return {
      isInitialized: true,
      data: {
        highlightScope,
  ...
  return (0, import_jsx_runtime15.jsx)(HighlightedContext.Provider, {
    value: providerValue,
    children
  });
}
...
function useHighlighted() {
  const {
    isInitialized,
    data
  } = React35.useContext(HighlightedContext);
  if (!isInitialized) {
...
function AnimationProvider(props) {
  ...
  const [skipAnimation2, setSkipAnimation] = React41.useState(isAnimationDisabledEnvironment || void 0);
  useIsomorphicLayoutEffect(() => {
    var _a;
  ...
  return (0, import_jsx_runtime16.jsx)(AnimationContext.Provider, {
    value,
    children
  });
}
...
function useSkipAnimation(skipAnimation2) {
  const {
    isInitialized,
    data
  } = React42.useContext(AnimationContext);
  if (!isInitialized) {
...
function ChartsText(props) {
  ...
  const wordsByLines = React46.useMemo(() => getWordsByLines({
    style,
...
var Portal = React51.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef(React51.isValidElement(children) ? getReactElementRef(children) : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
...
function PieArc(props) {
  ...
  return (0, import_jsx_runtime38.jsx)(PieArcRoot, _extends({
...
true ? PieArc.propTypes = {
  ...
  highlightScope: import_prop_types23.default.shape({
    fade: import_prop_types23.default.oneOf(["global", "none", "series"]),
    faded: import_prop_types23.default.oneOf(["global", "none", "series"]),
    highlight: import_prop_types23.default.oneOf(["item", "none", "series"]),
...
function useTransformData(series) {
  ...
  const dataWithHighlight = React74.useMemo(() => data.map((item, itemIndex) => {
    const currentItem = {
      seriesId,
      dataIndex: itemIndex
    };
...
function PieArcPlot(props) {
  ...
  return (0, import_jsx_runtime39.jsx)("g", _extends({}, other, {
    children: transition(({
      ...
      return (0, import_jsx_runtime39.jsx)(Arc, _extends({
        startAngle,
        endAngle,
        paddingAngle: pA,
        innerRadius: iR,
...
function PieArcLabel(props) {
  ...
  return (
    // @ts-expect-error
    (0, import_jsx_runtime40.jsx)(PieArcLabelRoot, _extends({
      className: classes.root
    }, other, {
      style: _extends({
...
true ? PieArcLabel.propTypes = {
  ...
  formattedArcLabel: import_prop_types25.default.string,
...
function PieArcLabelPlot(props) {
  ...
  return (0, import_jsx_runtime41.jsx)("g", _extends({}, other, {
    children: transition((_ref, item) => {
      ...
      return (0, import_jsx_runtime41.jsx)(ArcLabel, _extends({
        startAngle,
        endAngle,
        paddingAngle: pA,
        innerRadius: iR,
...
true ? PieArcLabelPlot.propTypes = {
   ...
   */
  arcLabel: import_prop_types26.default.oneOfType([import_prop_types26.default.oneOf(["formattedValue", "label", "value"]), import_prop_types26.default.func]),
  /**
   * The minimal angle required to display the arc label.
   * @default 0
   */
  arcLabelMinAngle: import_prop_types26.default.number,
  /**
   * The radius between circle center and the arc label in px.
   * @default (innerRadius - outerRadius) / 2
   */
  arcLabelRadius: import_prop_types26.default.number,
  /**
   * The radius applied to arc corners (similar to border radius).
   * @default 0
   */
  cornerRadius: import_prop_types26.default.number,
  data: import_prop_types26.default.arrayOf(import_prop_types26.default.shape({
    ...
    endAngle: import_prop_types26.default.number.isRequired,
    formattedValue: import_prop_types26.default.string.isRequired,
    ...
    label: import_prop_types26.default.oneOfType([import_prop_types26.default.func, import_prop_types26.default.string]),
    padAngle: import_prop_types26.default.number.isRequired,
    startAngle: import_prop_types26.default.number.isRequired,
   ...
   * @default { additionalRadius: -5 }
   */
  faded: import_prop_types26.default.shape({
    additionalRadius: import_prop_types26.default.number,
    arcLabelRadius: import_prop_types26.default.number,
    color: import_prop_types26.default.string,
    cornerRadius: import_prop_types26.default.number,
    innerRadius: import_prop_types26.default.number,
    outerRadius: import_prop_types26.default.number,
    paddingAngle: import_prop_types26.default.number
  }),
  /**
   * Override the arc attributes when it is highlighted.
   */
  highlighted: import_prop_types26.default.shape({
    additionalRadius: import_prop_types26.default.number,
    arcLabelRadius: import_prop_types26.default.number,
    color: import_prop_types26.default.string,
    cornerRadius: import_prop_types26.default.number,
   ...
   * The radius between circle center and the end of the arc.
   */
  outerRadius: import_prop_types26.default.number.isRequired,
  /**
   * The padding angle (deg) between two arcs.
   * @default 0
   */
...
function PiePlot(props) {
  ...
  return (0, import_jsx_runtime42.jsxs)("g", {
    children: [seriesOrder.map((seriesId) => {
      ...
      return (0, import_jsx_runtime42.jsx)("g", {
        transform: `translate(${left2 + cx}, ${top2 + cy})`,
        children: (0, import_jsx_runtime42.jsx)(PieArcPlot, {
          innerRadius,
          outerRadius,
          cornerRadius,
          paddingAngle,
      ...
      return (0, import_jsx_runtime42.jsx)("g", {
        transform: `translate(${left2 + cx}, ${top2 + cy})`,
        children: (0, import_jsx_runtime42.jsx)(PieArcLabelPlot, {
          innerRadius,
...
var PieChart = React82.forwardRef(function PieChart2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiPieChart"
  });
  ...
  return (0, import_jsx_runtime46.jsxs)(ResponsiveChartContainer, _extends({}, other, {
    ref,
    ...
    className,
    skipAnimation: skipAnimation2,
    children: [(0, import_jsx_runtime46.jsx)(ChartsAxis, {
      topAxis,
      leftAxis,
      rightAxis,
      bottomAxis,
      slots,
      slotProps
    }), (0, import_jsx_runtime46.jsx)(PiePlot, {
      slots,
      slotProps,
      onItemClick
    }), (0, import_jsx_runtime46.jsx)(ChartsOverlay, {
      loading,
      slots,
      slotProps
      ...
      slots,
      slotProps
    })), (0, import_jsx_runtime46.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), !loading && (0, import_jsx_runtime46.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slots,
      slotProps
    })), children]
  }));
